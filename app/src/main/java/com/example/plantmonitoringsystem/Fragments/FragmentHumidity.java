...
public class FragmentHumidity extends Fragment {
    ...
    public FragmentHumidity(String Zone) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        reference = FirebaseDatabase.getInstance().getReference(user.getUid()+"/Zones/"+zone+"/Humidity");
        // Inflate the layout for this fragment
        View root =  inflater.inflate(R.layout.fragment_humidity, container, false);
        listView = root.findViewById(R.id.list_zone_humid);
        params.clear();
