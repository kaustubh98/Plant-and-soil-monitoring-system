...
public class FragmentMoisture extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root =  inflater.inflate(R.layout.fragment_moisture, container, false);
        FirebaseUser user = FirebaseAuth.getInstance().getCurrentUser();
        reference = FirebaseDatabase.getInstance().getReference(user.getUid()+"/Zones/"+zone+"/Moisture");
        listView = root.findViewById(R.id.list_zone_moisture);
        params.clear();
